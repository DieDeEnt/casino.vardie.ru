...
if(empty($usernameOrEmail)){
    $_SESSION['validation']['usernameOrEmail'] = 'Please enter username or e-mail';
}
...
if (!$user) {
    $_SESSION['validation']['usernameOrEmail'] =  'User is not registered <a class="error-text sub-text" for="email" href="registerPage.php">Create account?</a>';
    // save old email
    setOldValue('usernameOrEmail',$usernameOrEmail);
    redirect('/loginPage.php');
}
